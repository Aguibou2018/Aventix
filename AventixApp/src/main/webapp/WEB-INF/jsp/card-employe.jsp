          ...
          <!-- Count item widget-->
            <div class="col-12">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Carte</strong><span>Informations Carte</span>
                </div>
              </div>
            </div>
        </div>
                ...
                <div class="card-body">
                  ...
                  <form class="form-horizontal">
                    <div class="form-group row">
                      <label class="col-sm-6">Numero Carte</label>
                      <div class="col-sm-6">
                        ${sessionScope['scopedTarget.sessionBeanEmploye'].employe.getCarte().getId()}
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-6">Plafond par jour :</label>
                      <div class="col-sm-6">
                        ${sessionScope['scopedTarget.sessionBeanEmploye'].employe.getCarte().getMontantMaxJournalier()}
                      </div>
                    </div>
                    <div class="form-group row">
